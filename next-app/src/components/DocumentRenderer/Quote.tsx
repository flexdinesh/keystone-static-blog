...
export function Quote({ attribution, content }: QuoteProps) {
  return (
    <div className="not-prose my-8">
      <blockquote className="relative bg-neutral-100 dark:bg-neutral-900 rounded-md pt-4 pr-3 pb-4 pl-12 after:content-['\201C'] after:absolute after:top-0 after:left-4 after:text-7xl">
