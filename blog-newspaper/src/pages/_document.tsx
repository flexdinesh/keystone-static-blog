...
export default function Document() {
  return (
    <Html className={`theme-newspaper`} lang="en">
      <Head>
        <link
          rel="icon"
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Roboto+Mono:ital,wght@0,400;0,600;0,700;0,800;1,400;1,700&display=block"
          rel="stylesheet"
        />
        {/* 
